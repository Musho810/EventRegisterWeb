...
public class EventManager {
    ...
    public void add(Event event) {
        String sql = "Insert into event (name,place,price,is_online,event_type,event_date) Values (?,?,?,?,?,?)";
    ...
    public Event getByName(String name) {
        String sql = "SELECT * From event_register.event where name ='" + name + "'";
        try {
            Statement statement = connection.createStatement();
            ResultSet resultSet = statement.executeQuery(sql);
    ...
    public void edit(Event event) {
        String sql = "update event set name=?,place=?,price=?,is_online=?,event_type=?,event_date=? where  id=?";
